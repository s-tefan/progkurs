import pathlib # Modul som används för att fixa så filen hittas
...
''' Från inlästa data, skapa en lista av dataposter från data'''
...
def timeline(dl, ad, variable):
    ...
    '''
    #######
    ### Din uppgift: Skriv här kod som implementerar funktionen enligt beskrivningen ovan 
    #######
